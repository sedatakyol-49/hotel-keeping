...
/**
 * ReportsPage — modul iskeleti.
 * Veri katmani (`reports.store.ts` + `core/api`) backend uc noktalari
...
@Component({
  ...
  template: `
    <div class="space-y-6">
      ...
      <hc-card titleKey="common.underDevelopment" headingId="reports-pending">
