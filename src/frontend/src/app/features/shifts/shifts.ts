...
/**
 * ShiftsPage — modul iskeleti.
 * Veri katmani (`shifts.store.ts` + `core/api`) backend uc noktalari
...
@Component({
  ...
  template: `
    <div class="space-y-6">
      ...
      <hc-empty-state
        titleKey="shifts.empty.title"
        descriptionKey="shifts.empty.description"
        eyebrowKey="common.underDevelopment"
      />

      <hc-card titleKey="common.underDevelopment" headingId="shifts-pending">
